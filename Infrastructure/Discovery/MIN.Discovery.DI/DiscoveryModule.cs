...
using MIN.Discovery.Transport.UdpBroadcast;
...
public class DiscoveryModule : Module
{
    ...
    protected override void Load(IServiceCollection services)
    {
        ...
        services.RegisterAsImplementedInterfaces<UdpBroadcastDiscoveryTransport>(ServiceLifetime.Singleton);
        services.RegisterAsImplementedInterfaces<UdpDiscoveryService>(ServiceLifetime.Singleton);
