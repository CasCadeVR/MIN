...
public interface IChatFileService
{
    ...
    /// Отправить файл
    /// </summary>
    Task SendFileAsync(Guid roomId, string content, string fileName, string filePath, Guid? recipientId = null, string? replyToDescription = null, CancellationToken cancellationToken = default);
