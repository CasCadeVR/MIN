...
public enum MessageTypeTag : byte
{
    ...
    // ===== Сообщения подкомнат (48-63) =====

    /// <summary>
    /// Запрос на хостинг подкомнаты.
    /// </summary>
    SubRoomHostRequest = 48,

    /// <summary>
    /// Ответ на запрос хостинг подкомнаты.
    /// </summary>
    SubRoomHostResponse = 49,

    /// <summary>
    /// Запрос на присоединение к подкомнате.
    /// </summary>
    SubRoomJoinRequest = 50,

    /// <summary>
    /// Ответ на присоединение к подкомнате.
    /// </summary>
    SubRoomJoinResponse = 51,

    /// <summary>
    /// Выходе из подкомнаты.
    /// </summary>
    SubRoomLeave = 52,

    /// <summary>
    /// Присоединение участника к подкомнате.
    /// </summary>
    SubRoomParticipantJoined = 53,
