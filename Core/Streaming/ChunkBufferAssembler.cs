...
internal sealed class ChunkBufferAssembler : IChunkBufferAssembler, IDisposable
{
    ...
    public Task AddChunkAsync(StreamChunk chunk, Guid connectionId, Guid roomId, bool requiresAcks, CancellationToken cancellationToken = default)
    {
